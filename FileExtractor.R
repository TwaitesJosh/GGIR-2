...
# example run
files <- list.files('G:\\Output\\output_C. REACT_12months_PA_data\\meta\\basic', pattern = '*.RData')
extract_all('G:\\Output\\output_C. REACT_12months_PA_data\\meta\\basic', files, 10, 0.04, 0.80)
